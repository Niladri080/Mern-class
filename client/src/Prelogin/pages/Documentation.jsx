          ...
          <div className="container mx-auto px-4 lg:px-8 max-w-5xl space-y-10">
            ...
            <section className="space-y-3">
              ...
              <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
                ...
                <li>
                  Log in and open the dashboard to start a new verification.
                </li>
                <li>
                  Upload required documents (ID, address proof, income proof,
                  etc.) and confirm your details.
                </li>
                <li>
                  Track the status of each request from the dashboard and
                  receive notifications when a document is approved or rejected.
                </li>
              </ol>
            </section>
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                <li>
                  Use the Verification Queue to see new and pending cases,
                  sorted by urgency.
                </li>
                <li>
