        ...
        <div className="space-y-6">
          <div className="bg-white border border-gray-200 rounded-lg">
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-900">Document Approvals</p>
                  <p className="text-xs text-gray-500">New documents for review</p>
                </div>
                <input
                  type="checkbox"
                  checked={notifications.documentApproval}
                  onChange={(e) => setNotifications({ ...notifications, documentApproval: e.target.checked })}
                  className="w-4 h-4"
                />
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-500">Summary of weekly activity</p>
                </div>
                <input
                  type="checkbox"
          ...
          <div className="bg-white border border-gray-200 rounded-lg">
            <div className="p-5 border-b border-gray-200">
              ...
              <p className="text-xs text-gray-500 mt-1">Read-only system information</p>
            </div>
            <div className="p-5 space-y-3">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-900">DocVerify-ML v3.2</p>
              </div>
              <div>
